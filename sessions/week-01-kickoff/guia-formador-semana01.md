...
> **Fecha sesión**: 2026-07-16 (jueves)  
...
| # | Qué | Dónde | Cuándo |
|---|-----|-------|--------|
| 1 | Repo público en GitHub con rama `week-01-start` | GitHub | D-7 (antes del 09 jul) |
| 2 | Esqueleto de código en `week-01-start` (TODOs) | GitHub | D-7 |
| 3 | Pipeline conectado en Azure DevOps | Azure DevOps | D-5 (antes del 11 jul) |
...
## PASO 4 — Comunicar a los participantes (D-2, martes 14 jul)
...
- [ ] Próxima rama `week-02-start` preparada (publicar lunes 20 jul)
